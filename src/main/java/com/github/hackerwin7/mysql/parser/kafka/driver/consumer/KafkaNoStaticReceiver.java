package com.github.hackerwin7.mysql.parser.kafka.driver.consumer;
 ...
 */
public class KafkaNoStaticReceiver {

    private Logger logger = LoggerFactory.getLogger(KafkaNoStaticReceiver.class);
    private KafkaNoStaticConf conf;
    ...
    public KafkaNoStaticReceiver(KafkaNoStaticConf cnf) {
        conf = cnf;
    }

    public KafkaNoStaticReceiver(KafkaNoStaticConf cnf, int qSize) {
        conf = cnf;
        MAXLEN = qSize;
    }
