 ...
 */
public class ParserVertifyKafkaSimple {

    private Logger logger = LoggerFactory.getLogger(ParserVertifyKafkaSimple.class);
    ...
    public ParserVertifyKafkaSimple(KafkaConf kc) {
        kcnf = kc;
        kr = new KafkaReceiver(kcnf);
    }

    public ParserVertifyKafkaSimple() {
...
//        kcnf.topic = "mysql_bb";
    ...
    public static void main(String[] args) throws Exception {
        ParserVertifyKafkaSimple par = new ParserVertifyKafkaSimple();
        par.initJson();
        par.dumpJson();
    }
